...
def upgrade() -> None:
    ...
    if 'phone_routing_rules' not in existing_tables:
        op.create_table(
            ...
            sa.Column('id', sa.Integer(), primary_key=True),
            sa.Column('org_id', sa.Integer(), sa.ForeignKey('organizations.id'), nullable=False),
            sa.Column('ring_owner_first', sa.Boolean(), nullable=False, server_default=sa.text('1')),
            ...
            sa.Column('send_caller_confirmation', sa.Boolean(), nullable=False, server_default=sa.text('1')),
    ...
    if 'call_events' not in existing_tables:
        op.create_table(
            ...
            sa.Column('answered_by_owner', sa.Boolean(), nullable=False, server_default=sa.text('0')),
            sa.Column('duration_seconds', sa.Integer(), nullable=True),
            sa.Column('is_after_hours', sa.Boolean(), nullable=False, server_default=sa.text('0')),
